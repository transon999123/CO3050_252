<div class="container mt-4 mb-5">
    <div class="row">
        <div class="col-md-6 mb-4">
            ...
            <p class="text-muted">Chúng tôi luôn sẵn sàng lắng nghe và giải đáp mọi thắc mắc của bạn về sản phẩm, dịch vụ và các vấn đề liên quan. Hãy liên hệ với chúng tôi!</p>
            
            <ul class="list-unstyled mt-4" style="line-height: 2.5;">
                <li><i class="fa fa-map-marker-alt text-danger mr-3 fa-lg"></i> <strong>Địa chỉ:</strong> 268 Lý Thường Kiệt, Phường 14, Quận 10, TP.HCM</li>
                <li><i class="fa fa-phone text-success mr-3 fa-lg"></i> <strong>Điện thoại:</strong> 0123.456.789 - 0987.654.321</li>
                <li><i class="fa fa-envelope text-primary mr-3 fa-lg"></i> <strong>Email:</strong> cskh@fashionstore.com</li>
                <li><i class="fa fa-clock text-warning mr-3 fa-lg"></i> <strong>Giờ làm việc:</strong> 8:00 AM - 9:00 PM (Tất cả các ngày trong tuần)</li>
            </ul>
        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="index.php?controller=contact&action=index" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" class="form-control" value="<?= htmlspecialchars($old['subject'] ?? '') ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg mt-4 shadow font-weight-bold"><i class="fa fa-paper-plane"></i> GỬI LIÊN HỆ</button>
                    </form>
                </div>
            </div>
        </div>
