<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
        <a class="navbar-brand font-weight-bold" href="index.php?controller=home&action=index">FASHION STORE</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="index.php?controller=contact&action=index">Liên hệ</a></li>
            </ul>
            <!-- Thanh Tìm Kiếm -->
            ...
            <ul class="navbar-nav">
                ...
                <?php if(isset($_SESSION['user_id'])): ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle font-weight-bold text-white" href="#" id="userDropdown" role="button" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php if(isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                                <a class="dropdown-item text-danger" href="index.php?controller=adminDashboard&action=index">Trang quản trị (Admin)</a>
                            <?php endif; ?>
                ...
                <?php else: ?>
                    <li class="nav-item"><a class="nav-link btn btn-outline-primary text-white" href="index.php?controller=auth&action=login">Đăng nhập</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
